...
git clone https://github.com/kchmck/vim-coffee-script.git ~/.janus/vim-coffee-script
...
git clone https://github.com/bronson/vim-trailing-whitespace.git ~/.janus/vim-trailing-whitespace
